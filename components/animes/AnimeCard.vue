<template>
  <NuxtLink :to="`/animes/${id}`" class="flex flex-col relative group p-1">
    <div class="flex flex-col">
      <div
        class="absolute break-words top-0 left-0 right-0 h-full bg-black p-2 opacity-0 group-hover:opacity-90 duration-300"
      >
